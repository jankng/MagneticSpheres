// This file contains edits to the source code of the GNU Scientific Library as permitted
// by the GNU General Public License
//
// Created by jan on 4/14/19.
//

/* original file siman/siman.c
 *
 * Changes made by Jan König
...
/* implementation of a basic simulated annealing algorithm */
                     ...
                     gsl_siman_params_t params)
    {
        ...
        /* this function requires that either the dynamic functions (copy,
           ...
           size is given */
        assert((copyfunc != nullptr && copy_constructor != nullptr && destructor != nullptr)
               || (element_size != 0));
